...
const MODULOS: Modulo[] = [
  { id: "memoria", nombre: "MEMORIA", color: "#3ba0dc", icono: "brain", ruta: "/modulo/memoria" },
  {
    ...
    nombre: "COORDINACION",
    color: "#2ecc71",
    icono: "hand-pointing-up",
    ruta: "/modulo/coordinacion",
  },
  {
    id: "razonamiento",
    nombre: "RAZONAMIENTO",
  ...
  },
  {
    ...
    color: "#e74c3c",
    icono: "eye-outline",
    ruta: "/modulo/atencion",
  },
  {
    id: "visoespacial",
    nombre: "VISOESPACIAL",
    color: "#9b59b6",
    icono: "map-marker-radius-outline",
    ruta: "/modulo/visoespacial",
  },
  {
    id: "cognitivas",
    nombre: "COGNITIVAS",
